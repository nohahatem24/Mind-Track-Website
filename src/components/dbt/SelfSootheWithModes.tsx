...
const SelfSootheContent: React.FC<SelfSootheWithModesProps> = ({
  onComplete,
  onCancel,
  initialData,
  isEditing,
...
const SelfSootheWithModes: React.FC<SelfSootheWithModesProps> = (props) => {
  return (
    <InteractionModeProvider>
      <SelfSootheContent {...props} />
    </InteractionModeProvider>
  );
};

export default SelfSootheWithModes;
