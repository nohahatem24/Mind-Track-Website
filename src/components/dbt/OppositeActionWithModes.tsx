...
interface OppositeActionWithModesProps {
...
const OppositeActionContent: React.FC<OppositeActionWithModesProps> = ({
  onComplete,
  onCancel,
  initialData,
  isEditing,
...
const OppositeActionWithModes: React.FC<OppositeActionWithModesProps> = (props) => {
  return (
    <InteractionModeProvider>
      <OppositeActionContent {...props} />
    </InteractionModeProvider>
  );
};

export default OppositeActionWithModes;
