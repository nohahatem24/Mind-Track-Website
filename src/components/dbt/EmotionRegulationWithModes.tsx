...
interface EmotionRegulationWithModesProps {
...
const EmotionRegulationContent: React.FC<EmotionRegulationWithModesProps> = ({
  onComplete,
  onCancel,
  initialData,
  isEditing,
...
const EmotionRegulationWithModes: React.FC<EmotionRegulationWithModesProps> = (props) => {
  return (
    <InteractionModeProvider>
      <EmotionRegulationContent {...props} />
    </InteractionModeProvider>
  );
};

export default EmotionRegulationWithModes;
