...
interface InterpersonalEffectivenessWithModesProps {
...
const InterpersonalEffectivenessContent: React.FC<InterpersonalEffectivenessWithModesProps> = ({
  onComplete,
  onCancel,
  initialData,
  isEditing,
...
const InterpersonalEffectivenessWithModes: React.FC<InterpersonalEffectivenessWithModesProps> = (props) => {
  return (
    <InteractionModeProvider>
      <InterpersonalEffectivenessContent {...props} />
    </InteractionModeProvider>
  );
};

export default InterpersonalEffectivenessWithModes;
