...
interface OneMinuteMindfulnessWithModesProps {
...
const OneMinuteMindfulnessContent: React.FC<OneMinuteMindfulnessWithModesProps> = ({
  onComplete,
  onCancel,
  initialData,
  isEditing,
...
const OneMinuteMindfulnessWithModes: React.FC<OneMinuteMindfulnessWithModesProps> = (props) => {
  return (
    <InteractionModeProvider>
      <OneMinuteMindfulnessContent {...props} />
    </InteractionModeProvider>
  );
};

export default OneMinuteMindfulnessWithModes;
